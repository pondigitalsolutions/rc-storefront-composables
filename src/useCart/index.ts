...
import {
    ...
    updateFulfillmentMethodsForCart as apiUpdateFulfillmentMethods,
    selectFulfillmentMethod as apiSetFulfillmentMethod,
...
const removeFromCart = async (params: {
    ...
    const removeFromCartResponse = await apiRemoveFromCart({
        cartId: params.cartId,
        cartToken: params.cartToken,
...
export const updateShippingMethods = async (params: {
    ...
    const updateResult = await apiUpdateFulfillmentMethods(params);
    const fulfillmentGroup = cartGetters.getFulfillmentGroup(
...
export const setFulfillmentMethod = async (params: {
    ...
    const setShippingMethodResult = await apiSetFulfillmentMethod(params);
